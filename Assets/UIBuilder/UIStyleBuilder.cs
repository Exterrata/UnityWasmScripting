...
namespace Koneko.UIBuilder {
	public static partial class UIElementBuilder {
		...
		public static StyleStruct AlignSelf(Align value) => new(StyleType.AlignSelf) { Align = value };

		public static StyleStruct BackgroundColor(Color value) => new(StyleType.BackgroundColor) { Color = value };

		public static StyleStruct BackgroundImage(StyleBackground value) => new(StyleType.BackgroundImage) { Background = value };

		public static StyleStruct BorderBottomColor(Color value) => new(StyleType.BorderBottomColor) { Color = value };

		public static StyleStruct BorderBottomLeftRadius(Length value) => new(StyleType.BorderBottomLeftRadius) { Length = value };

		public static StyleStruct BorderBottomRightRadius(Length value) => new(StyleType.BorderBottomRightRadius) { Length = value };

		public static StyleStruct BorderBottomWidth(float value) => new(StyleType.BorderBottomWidth) { Float = value };

		public static StyleStruct BorderLeftColor(Color value) => new(StyleType.BorderLeftColor) { Color = value };

		public static StyleStruct BorderLeftWidth(float value) => new(StyleType.BorderLeftWidth) { Float = value };

		public static StyleStruct BorderRightColor(Color value) => new(StyleType.BorderRightColor) { Color = value };

		public static StyleStruct BorderRightWidth(float value) => new(StyleType.BorderRightWidth) { Float = value };

		public static StyleStruct BorderTopColor(Color value) => new(StyleType.BorderTopColor) { Color = value };

		public static StyleStruct BorderTopLeftRadius(Length value) => new(StyleType.BorderTopLeftRadius) { Length = value };

		public static StyleStruct BorderTopRightRadius(Length value) => new(StyleType.BorderTopRightRadius) { Length = value };

		public static StyleStruct BorderTopWidth(float value) => new(StyleType.BorderTopWidth) { Float = value };
		...
		public static StyleStruct Cursor(StyleCursor value) => new(StyleType.Cursor) { Cursor = value };

		public static StyleStruct Display(DisplayStyle value) => new(StyleType.Display) { DisplayStyle = value };

		public static StyleStruct FlexBasis(Length value) => new(StyleType.FlexBasis) { Length = value };

		public static StyleStruct FlexDirection(FlexDirection value) => new(StyleType.FlexDirection) { FlexDirection = value };

		public static StyleStruct FlexGrow(float value) => new(StyleType.FlexGrow) { Float = value };

		public static StyleStruct FlexShrink(float value) => new(StyleType.FlexShrink) { Float = value };

		public static StyleStruct FlexWrap(Wrap value) => new(StyleType.FlexWrap) { Wrap = value };

		public static StyleStruct FontSize(Length value) => new(StyleType.FontSize) { Length = value };

		public static StyleStruct Height(Length value) => new(StyleType.Height) { Length = value };

		public static StyleStruct JustifyContent(Justify value) => new(StyleType.JustifyContent) { Justify = value };

		public static StyleStruct Left(Length value) => new(StyleType.Left) { Length = value };

		public static StyleStruct LetterSpacing(Length value) => new(StyleType.LetterSpacing) { Length = value };

		public static StyleStruct MarginBottom(Length value) => new(StyleType.MarginBottom) { Length = value };

		public static StyleStruct MarginLeft(Length value) => new(StyleType.MarginLeft) { Length = value };

		public static StyleStruct MarginRight(Length value) => new(StyleType.MarginRight) { Length = value };

		public static StyleStruct MarginTop(Length value) => new(StyleType.MarginTop) { Length = value };

		public static StyleStruct MaxHeight(Length value) => new(StyleType.MaxHeight) { Length = value };

		public static StyleStruct MaxWidth(Length value) => new(StyleType.MaxWidth) { Length = value };

		public static StyleStruct MinHeight(Length value) => new(StyleType.MinHeight) { Length = value };

		public static StyleStruct MinWidth(Length value) => new(StyleType.MinWidth) { Length = value };

		public static StyleStruct Opacity(float value) => new(StyleType.Opacity) { Float = value };

		public static StyleStruct Overflow(Overflow value) => new(StyleType.Overflow) { Overflow = value };

		public static StyleStruct PaddingBottom(Length value) => new(StyleType.PaddingBottom) { Length = value };

		public static StyleStruct PaddingLeft(Length value) => new(StyleType.PaddingLeft) { Length = value };

		public static StyleStruct PaddingRight(Length value) => new(StyleType.PaddingRight) { Length = value };

		public static StyleStruct PaddingTop(Length value) => new(StyleType.PaddingTop) { Length = value };

		public static StyleStruct Position(Position value) => new(StyleType.Position) { Position = value };
		...
		public static StyleStruct TextOverflow(TextOverflow value) => new(StyleType.TextOverflow) { TextOverflow = value };

		public static StyleStruct TextShadow(TextShadow value) => new(StyleType.TextShadow) { TextShadow = value };

		public static StyleStruct Top(Length value) => new(StyleType.Top) { Length = value };

		public static StyleStruct TransformOrigin(TransformOrigin value) => new(StyleType.TransformOrigin) { TransformOrigin = value };

		public static StyleStruct TransitionDelay(List<TimeValue> value) => new(StyleType.TransitionDelay) { TimeValue = value };

		public static StyleStruct TransitionDuration(List<TimeValue> value) => new(StyleType.TransitionDuration) { TimeValue = value };

		public static StyleStruct TransitionProperty(StyleList<StylePropertyName> value) => new(StyleType.TransitionProperty) { PropertyName = value };

		public static StyleStruct TransitionTimingFunction(StyleList<EasingFunction> value) => new(StyleType.TransitionTimingFunction) { EasingFunction = value };

		public static StyleStruct Translate(Translate value) => new(StyleType.Translate) { Translate = value };

		public static StyleStruct UnityBackgroundImageTintColor(Color value) => new(StyleType.UnityBackgroundImageTintColor) { Color = value };

		public static StyleStruct UnityBackgroundScaleMode(StyleEnum<ScaleMode> value) => new(StyleType.UnityBackgroundScaleMode) { ScaleMode = value };

		public static StyleStruct UnityFont(Font value) => new(StyleType.UnityFont) { Font = value };

		public static StyleStruct UnityFontDefinition(FontDefinition value) => new(StyleType.UnityFontDefinition) { FontDefinition = value };

		public static StyleStruct UnityFontStyleAndWeight(FontStyle value) => new(StyleType.UnityFontStyleAndWeight) { FontStyle = value };

		public static StyleStruct UnityOverflowClipBox(OverflowClipBox value) => new(StyleType.UnityOverflowClipBox) { OverflowClipBox = value };

		public static StyleStruct UnityParagraphSpacing(Length value) => new(StyleType.UnityParagraphSpacing) { Length = value };

		public static StyleStruct UnitySliceBottom(int value) => new(StyleType.UnitySliceBottom) { Int = value };

		public static StyleStruct UnitySliceLeft(int value) => new(StyleType.UnitySliceLeft) { Int = value };

		public static StyleStruct UnitySliceRight(int value) => new(StyleType.UnitySliceRight) { Int = value };

		public static StyleStruct UnitySliceTop(int value) => new(StyleType.UnitySliceScale) { Int = value };

		public static StyleStruct UnitySliceScale(float value) => new(StyleType.UnitySliceTop) { Float = value };

		public static StyleStruct UnityTextAlign(TextAnchor value) => new(StyleType.UnityTextAlign) { TextAnchor = value };

		public static StyleStruct UnityTextOutlineColor(Color value) => new(StyleType.UnityTextOutlineColor) { Color = value };

		public static StyleStruct UnityTextOutlineWidth(float value) => new(StyleType.UnityTextOutlineWidth) { Float = value };

		public static StyleStruct UnityTextOverflowPosition(TextOverflowPosition value) => new(StyleType.UnityTextOverflowPosition) { TextOverflowPosition = value };

		public static StyleStruct Visibility(Visibility value) => new(StyleType.Visibility) { Visibility = value };

		public static StyleStruct WhiteSpace(WhiteSpace value) => new(StyleType.WhiteSpace) { WhiteSpace = value };
