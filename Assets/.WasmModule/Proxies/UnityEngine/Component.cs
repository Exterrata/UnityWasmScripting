...
public partial class Component(long id) : Object(id)
{
    ...
    public Component GetComponent(string name) =>
        internal_component_getComponent_string(WrappedId, name);

    public Component GetComponent(Type type) =>
        internal_component_getComponent_type(WrappedId, type);
    ...
    private static unsafe Component internal_component_getComponent_string(
        long wrappedId,
        string name
    )
    {
        ...
        fixed (char* str = name)
        {
            long id = component_getComponent_string(
                wrappedId,
                (long)str,
            ...
            Component component =
                RuntimeHelpers.GetUninitializedObject(TypeMap.GetType(componentType)) as Component;
    ...
    [WasmImportLinkage, DllImport("unity")]
    private static extern long component_getComponent_string(
        long wrappedId,
        long componentStr,
        int componentStrLength,
        long outComponentType
    );

    [WasmImportLinkage, DllImport("unity")]
    private static extern long component_getComponent_type(
        long wrappedId,
        int componentTypeId,
        long outComponentType
    );
