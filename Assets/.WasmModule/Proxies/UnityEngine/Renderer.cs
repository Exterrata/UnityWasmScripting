...
{
    public void GetSharedMaterials(List<Material> materials) =>
        internal_renderer_getSharedMaterials(WrappedId, materials);

    private static unsafe void internal_renderer_getSharedMaterials(
        long wrappedId,
    ...
    private static extern void renderer_getSharedMaterials(
        long id,
        long outMaterialIds,
        long outMaterialsLength
    );
}
